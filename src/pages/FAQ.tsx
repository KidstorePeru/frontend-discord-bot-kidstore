...
const FAQS_ES = [
  ...
  { q: '¿Qué son los KidCoins (KC)?', a: 'Los KidCoins son la moneda interna de KidStorePeru. Con ellos puedes comprar cualquier ítem disponible en la tienda. Puedes recargarlos con MercadoPago, dLocal Go, PayPal o criptomonedas, o de forma manual con Yape, Plin, BCP y BBVA (Perú) o Bizum (España).' },
  { q: '¿Qué métodos de pago aceptan?', a: 'Pasarelas automáticas (al instante): MercadoPago en Perú (tarjetas y Yape); y en el resto del mundo, dLocal Go (tarjetas internacionales y métodos locales), PayPal y criptomonedas. Métodos manuales (con periodo de espera): en Perú, Yape, Plin, BCP, Interbank y BBVA; en España, Bizum — con estos verificamos tu pago a mano antes de liberar tus KC, así que la entrega no es inmediata.' },
...
const FAQS_EN = [
  ...
  { q: 'What are KidCoins (KC)?', a: 'KidCoins are the internal currency of KidStorePeru. You can use them to buy any item available in the store. Recharge them with MercadoPago, dLocal Go, PayPal, or cryptocurrency, or manually via Yape, Plin, BCP, and BBVA (Peru) or Bizum (Spain).' },
  { q: 'What payment methods do you accept?', a: 'Automatic gateways (instant): MercadoPago in Peru (cards and Yape); and elsewhere, dLocal Go (international cards and local methods), PayPal, and cryptocurrency. Manual methods (with a waiting period): in Peru, Yape, Plin, BCP, Interbank, and BBVA; in Spain, Bizum — with these we verify your payment by hand before releasing your KC, so delivery isn\'t immediate.' },
