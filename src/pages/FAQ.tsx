...
const FAQS_ES = [
  ...
  { q: '¿Qué son los KidCoins (KC)?', a: 'Los KidCoins son la moneda interna de KidStorePeru. Con ellos puedes comprar cualquier ítem disponible en la tienda. Puedes recargarlos con MercadoPago, PayPal, criptomonedas (NOWPayments), Yape, Plin, BCP, Interbank o BBVA.' },
  { q: '¿Qué métodos de pago aceptan?', a: 'Pasarelas automáticas: MercadoPago (tarjetas, Yape digital), PayPal (tarjetas internacionales) y NOWPayments (BTC, ETH, USDT). Métodos manuales: Yape, Plin, BCP, Interbank, BBVA y Bizum. Los pagos por pasarela se acreditan al instante; los manuales requieren aprobación del administrador.' },
...
const FAQS_EN = [
  ...
  { q: 'What are KidCoins (KC)?', a: 'KidCoins are the internal currency of KidStorePeru. You can use them to buy any item available in the store. Recharge them with MercadoPago, PayPal, crypto (NOWPayments), Yape, Plin, BCP, Interbank, or BBVA.' },
  { q: 'What payment methods do you accept?', a: 'Automatic gateways: MercadoPago (cards, digital Yape), PayPal (international cards), and NOWPayments (BTC, ETH, USDT). Manual methods: Yape, Plin, BCP, Interbank, BBVA, and Bizum. Gateway payments are credited instantly; manual payments require admin approval.' },
