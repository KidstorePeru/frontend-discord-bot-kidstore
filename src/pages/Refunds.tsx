    ...
    <div className="legal-page">
      <div className="legal-inner">
        ...
        {es ? (<div className="legal-body"><div className="legal-highlight legal-highlight-warning"><strong>Importante:</strong> Al comprar en KidStorePeru, aceptas esta política.</div>
            ...
            <h2>2. Pagos por pasarela (MercadoPago, dLocal Go, PayPal, criptomonedas)</h2>
            <p>Si realizaste el pago a través de MercadoPago (Perú) o dLocal Go, PayPal o criptomonedas (resto del mundo), puedes abrir una disputa o reclamo directamente con la pasarela correspondiente según sus propios plazos y condiciones. KidStorePeru colaborará proporcionando la información necesaria para resolver el caso.</p>
            <h2>3. Pagos manuales (Yape, Plin, BCP, Interbank, BBVA — Perú; Bizum — España)</h2>
            ...
            <h2>2. Gateway payments (MercadoPago, dLocal Go, PayPal, cryptocurrency)</h2>
            <p>If you paid via MercadoPago (Peru) or dLocal Go, PayPal, or cryptocurrency (rest of the world), you can open a dispute or claim directly with the corresponding gateway according to their own timelines and conditions. KidStorePeru will cooperate by providing the necessary information to resolve the case.</p>
            <h2>3. Manual payments (Yape, Plin, BCP, Interbank, BBVA — Peru; Bizum — Spain)</h2>
            ...
            <ul><li>The order shows as delivered in-game</li><li>Incorrect data was provided and delivery was completed</li><li>Restrictions or bans imposed by Epic Games</li><li>Change of mind once the order is processed</li><li>KidCoins already credited from a verified manual payment</li></ul>
